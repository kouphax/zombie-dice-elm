...
Elm.ZombieDice = Elm.ZombieDice || {};
Elm.ZombieDice.make = function (_elm) {
   "use strict";
   _elm.ZombieDice = _elm.ZombieDice || {};
   if (_elm.ZombieDice.values)
   return _elm.ZombieDice.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ZombieDice",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var wonGame = A2($Html.img,
   _L.fromArray([$Html$Attributes.src("images/gold-brain.png")
   ...
   model) {
      return function () {
         ...
         {case "Add":
            ...
            case "Finish":
            return function () {
                 var winnerId = $Maybe.withDefault(0)($Maybe.map(function (_) {
                    return _.id;
                 })($List.head($List.reverse($List.sortBy(function (_) {
                    return _.score;
                 })(model.players)))));
                 var win = function (p) {
                    return _U.eq(p.id,
                    winnerId) ? _U.replace([["score"
                                            ,0]
                                           ,["gamesWon",p.gamesWon + 1]],
                    p) : _U.replace([["score",0]],
                    p);
                 };
                 return _U.replace([["players"
                                    ,A2($List.map,
   ...
   var ResetAll = {ctor: "ResetAll"};
   var Reset = {ctor: "Reset"};
   var Inc = function (a) {
      return {ctor: "Inc",_0: a};
   };
   var playerEntry = F2(function (address,
   player) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("row")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col span_3 name")]),
                   _L.fromArray([A2($Html.h2,
                                ...
                                _L.fromArray([]),
                                A2($List.map,
                                $Basics.always(wonGame),
                                _L.range(1,player.gamesWon)))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col span_3")]),
                   _L.fromArray([A2($Html.img,
                                _L.fromArray([$Html$Attributes.$class("brain")
                                             ,$Html$Attributes.src("images/brain.png")
                                ...
                                _L.fromArray([A2($Html.small,
                                             _L.fromArray([]),
                                             _L.fromArray([$Html.text("x")]))
                                             ,A2($Html.span,
                                             _L.fromArray([]),
                                             _L.fromArray([$Html.text($Basics.toString(player.score))]))]))]))]));
   });
   var Add = function (a) {
   ...
   var scoreCard = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.h1,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Zombie Dice")]))
                   ,A2($Html.h2,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Score Card")]))
                   ,A2($Html.div,
                   ...
                   _L.fromArray([A2($Html.button,
                                ...
                                address,
                                Prompt)]),
                                _L.fromArray([$Html.text("Add Player")]))
                                ,A2($Html.button,
                                _L.fromArray([A2($Html$Events.onClick,
                                address,
                                Reset)]),
                                _L.fromArray([$Html.text("Reset Scores")]))
                                ,A2($Html.button,
                                _L.fromArray([A2($Html$Events.onClick,
                                address,
                                ResetAll)]),
                                _L.fromArray([$Html.text("Clear All!")]))
                                ,A2($Html.button,
                                _L.fromArray([A2($Html$Events.onClick,
                                address,
                                Finish)]),
                                _L.fromArray([$Html.text("Finish Game")]))]))
                   ,A2($Html.div,
   ...
   NoOp)(actions.signal)));
   _elm.ZombieDice.values = {_op: _op
                            ,NoOp: NoOp
                            ,Prompt: Prompt
                            ,Add: Add
                            ,Inc: Inc
